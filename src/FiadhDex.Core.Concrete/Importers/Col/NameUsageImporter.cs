...
using FiadhDex.Static.Constants.Col.Existence.Extinct;
using FiadhDex.Static.Constants.Col.Flagged;
...
public sealed class NameUsageImporter
{
    ...
    private readonly FiadhDexDbContext _context;
    private readonly PipelineConfig _config;

    public NameUsageImporter(FiadhDexDbContext context, IOptions<PipelineConfig> options)
    {
        _context = context;
