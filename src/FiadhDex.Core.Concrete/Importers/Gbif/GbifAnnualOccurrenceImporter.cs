...
using FiadhDex.Static.Constants.Gbif.MappingModels;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Options;

namespace FiadhDex.Core.Concrete.Importers.Gbif;
...
public sealed class GbifAnnualOccurrenceImporter
{
    ...
    public GbifAnnualOccurrenceImporter(FiadhDexDbContext context, IOptions<PipelineConfig> options)
    {
        _dbContext = context;
