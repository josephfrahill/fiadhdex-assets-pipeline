    ...
    public async Task<int> ImportAsync()
    {
        ...
        while (true)
        {
            ...
            var record = new VernacularName
            {
                ...
                Preferred = bool.TryParse(Get(values, ColVernacularNameColumns.Preferred), out var preferred) &&
                            preferred,
                Country = NullIfEmpty(Get(values, ColVernacularNameColumns.Country)),
                Area = NullIfEmpty(Get(values, ColVernacularNameColumns.Area)),
                Merged = bool.TryParse(Get(values, ColVernacularNameColumns.Merged), out var merged) && merged
            };
